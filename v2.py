# The Beloved V2 Mode where the AI can do other accents, and different tones dynamically.
import os
import asyncio
import base64
import io
...
class APIKeyManager:
    ...
    def can_switch_key(self, ignore_cooldown: bool = False):
        ...
        total_keys = 1 + len(self.backup_keys) 
        ...
        while True:
            ...
            try:
                ...
                if hasattr(_tools, 'set_ai_speaking'):
                    ...
                    try:
                        if hasattr(_tools, 'notify_ai_turn_complete'):
                            _tools.notify_ai_turn_complete()
                    except Exception as notify_err:
                        logger.warning(f"V2 YAP turn notification error: {notify_err}")
            except Exception:
                pass
        ...
        while True:
            ...
            try:
                ...
                if consecutive_failures >= 3:
                    extra_delay = min(consecutive_failures * 5, 60) 
